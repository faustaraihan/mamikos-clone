...
import { selectSection } from "@/lib/local-data"
...
export function HomePage() {
  return (
    <>
      <HomeHero />
      <PageContainer>
        <RoomListSection title="Promo Ngebut" rooms={selectSection("section-promo")} />
        <RoomListSection title="Rekomendasi kos" rooms={selectSection("section-featured")} />
        <RoomListSection title="Kos yang lagi promo di" rooms={selectSection("section-nearby")} />
        <PopularAreaSection />
